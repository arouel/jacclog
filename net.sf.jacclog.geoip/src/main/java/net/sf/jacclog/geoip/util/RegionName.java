...
public final class RegionName {
	...
	public static String determine(final String countryCode, final String regionCode) {
		...
		if (regionCode == null || regionCode.isEmpty()) {
			throw new IllegalArgumentException("Argument 'regionCode' can not be null or empty.");
		}
		...
		if (((regionCode.charAt(0) >= 48) && (regionCode.charAt(0) < (48 + 10)))
			...
			regionCode2 = (regionCode.charAt(0) - 48) * 10 + regionCode.charAt(1) - 48;
		} else if ((((regionCode.charAt(0) >= 65) && (regionCode.charAt(0) < (65 + 26))) || ((regionCode.charAt(0) >= 48) && (regionCode
				.charAt(0) < (48 + 10))))
				&& (((regionCode.charAt(1) >= 65) && (regionCode.charAt(1) < (65 + 26))) || ((regionCode.charAt(1) >= 48) && (regionCode
						.charAt(1) < (48 + 10))))) {

			regionCode2 = (regionCode.charAt(0) - 48) * (65 + 26 - 48) + regionCode.charAt(1) - 48 + 100;
		}
