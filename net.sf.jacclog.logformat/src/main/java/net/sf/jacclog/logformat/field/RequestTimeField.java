 ...
 */
public final class RequestTimeField extends AbstractLogFormatField {
	...
	private static class FieldHolder {
		public static final RequestTimeField INSTANCE = new RequestTimeField(FieldType.REQUEST_TIME);
	}

	public static RequestTimeField getInstance() {
	 ...
	 * @param parameter
	 */
	private RequestTimeField(final FieldType type) {
		super(type);
	}
