 ...
 */
public final class LocalIpAddressField extends AbstractLogFormatField {
	...
	private static class FieldHolder {
		public static final LocalIpAddressField INSTANCE = new LocalIpAddressField(FieldType.LOCAL_IP_ADDRESS);
	}

	public static LocalIpAddressField getInstance() {
	 ...
	 * @param parameter
	 */
	private LocalIpAddressField(final FieldType type) {
		super(type);
	}
