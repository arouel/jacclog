 ...
 */
public final class ServerPortField extends AbstractLogFormatField {
	...
	private static class FieldHolder {
		public static final ServerPortField INSTANCE = new ServerPortField(FieldType.SERVER_PORT);
	}

	public static ServerPortField getInstance() {
	 ...
	 * @param parameter
	 */
	private ServerPortField(final FieldType type) {
		super(type);
	}
