 ...
 * Filename<br>
 * <br>
 * <strong>Field:</strong> %f
 */
public final class FilenameField extends AbstractLogFormatField {
	...
	private static class FieldHolder {
		public static final FilenameField INSTANCE = new FilenameField(FieldType.FILENAME);
	}

	public static FilenameField getInstance() {
	 ...
	 * @param parameter
	 */
	private FilenameField(final FieldType type) {
		super(type);
	}
