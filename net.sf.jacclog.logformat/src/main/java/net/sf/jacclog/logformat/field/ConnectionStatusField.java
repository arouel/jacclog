 ...
 * </ul>
 * <br>
 * <strong>Field:</strong> %X
 */
public final class ConnectionStatusField extends AbstractLogFormatField {
	...
	private static class FieldHolder {
		public static final ConnectionStatusField INSTANCE = new ConnectionStatusField(
				FieldType.CONNECTION_STATUS);
	}

	public static ConnectionStatusField getInstance() {
	 ...
	 * @param parameter
	 */
	private ConnectionStatusField(final FieldType type) {
		super(type);
	}
