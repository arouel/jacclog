 ...
 */
public final class UrlPathField extends AbstractLogFormatField {
	...
	private static class FieldHolder {
		public static final UrlPathField INSTANCE = new UrlPathField(FieldType.URL_PATH);
	}

	public static UrlPathField getInstance() {
	 ...
	 * @param parameter
	 */
	private UrlPathField(final FieldType type) {
		super(type);
	}
