 ...
 */
public final class ServerNameField extends AbstractLogFormatField {
	...
	private static class FieldHolder {
		public static final ServerNameField INSTANCE = new ServerNameField(FieldType.SERVERNAME);
	}

	public static ServerNameField getInstance() {
	 ...
	 * @param parameter
	 */
	private ServerNameField(final FieldType type) {
		super(type);
	}
