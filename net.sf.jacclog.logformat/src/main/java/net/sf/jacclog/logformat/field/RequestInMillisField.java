 ...
 * <br>
 * <strong>Field:</strong> %D
 */
public final class RequestInMillisField extends AbstractLogFormatField {
	...
	private static class FieldHolder {
		public static final RequestInMillisField INSTANCE = new RequestInMillisField(
				FieldType.REQUEST_IN_MILLIS);
	}

	public static RequestInMillisField getInstance() {
	 ...
	 * @param parameter
	 */
	private RequestInMillisField(final FieldType type) {
		super(type);
	}
