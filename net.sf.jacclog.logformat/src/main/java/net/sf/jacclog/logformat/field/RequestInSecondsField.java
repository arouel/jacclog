 ...
 * <br>
 * <strong>Field:</strong> %T
 */
public final class RequestInSecondsField extends AbstractLogFormatField {
	...
	private static class FieldHolder {
		public static final RequestInSecondsField INSTANCE = new RequestInSecondsField(
				FieldType.REQUEST_IN_SECONDS);
	}

	public static RequestInSecondsField getInstance() {
	 ...
	 * @param parameter
	 */
	private RequestInSecondsField(final FieldType type) {
		super(type);
	}
