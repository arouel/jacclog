 ...
 * <br>
 * <strong>Field:</strong> %v
 */
public final class CanonicalServerNameField extends AbstractLogFormatField {
	...
	private static class FieldHolder {
		public static final CanonicalServerNameField INSTANCE = new CanonicalServerNameField(
				FieldType.SERVERNAME_CANONICAL);
	}

	public static CanonicalServerNameField getInstance() {
	 ...
	 * @param parameter
	 */
	private CanonicalServerNameField(final FieldType type) {
		super(type);
	}
