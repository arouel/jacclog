 ...
 */
public final class RequestMethodField extends AbstractLogFormatField {
	...
	private static class FieldHolder {
		public static final RequestMethodField INSTANCE = new RequestMethodField(FieldType.REQUEST_METHOD);
	}

	public static RequestMethodField getInstance() {
	 ...
	 * @param parameter
	 */
	private RequestMethodField(final FieldType type) {
		super(type);
	}
