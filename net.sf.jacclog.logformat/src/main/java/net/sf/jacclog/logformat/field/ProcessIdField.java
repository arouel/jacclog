 ...
 */
public final class ProcessIdField extends AbstractLogFormatField {
	...
	private static class FieldHolder {
		public static final ProcessIdField INSTANCE = new ProcessIdField(FieldType.PROCESS_ID);
	}

	public static ProcessIdField getInstance() {
	 ...
	 * @param parameter
	 */
	private ProcessIdField(final FieldType type) {
		super(type);
	}
