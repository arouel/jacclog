...
public class BrowserPattern implements OrderedPattern {
	...
	public static class Builder {
		...
		public BrowserPattern build() {
			return new BrowserPattern(id, pattern, order);
		}
	...
	public BrowserPattern(final int id, final Pattern pattern, final int order) {
		if (id < 0) {
			throw new IllegalArgumentException("Argument 'id' can not be null.");
		}
