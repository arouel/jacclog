...
public interface LogEntryService<E extends ReadableLogEntry<? extends ReadableHttpRequestHeaderField, ? extends ReadableHttpResponseHeaderField>> {
	 ...
	 * @return A list of log entries
	 */
	List<E> find(final Interval interval);
	 ...
	 * @return A list of log entries
	 */
	List<E> find(final Interval interval, final int startPosition, final int maxResults);
