...
public class LogEntriesImportTask extends RecursiveAction {
	...
	public LogEntriesImportTask(final LogEntryRepositoryService<PersistableLogEntry> service,
	...
	protected void compute() {
		if (maxResults < THRESHOLD) {
			...
			final LogEntriesImportTask a1 = new LogEntriesImportTask(service, this.entries, startPosition, midpoint);
			final LogEntriesImportTask a2 = new LogEntriesImportTask(service, this.entries, startPosition + midpoint,
					maxResults - midpoint);
			invokeAll(a1, a2);
		}
	}
